...
CATEGORIES = [
    {
        ...
        "name_am": "ኤሌክትሮኒክስ",
        "slug": "electronics",
        "description": "Phones, TVs, and gadgets",
        "description_am": "ስልኮች፣ ቴሌቪዥኖች እና ጂንጅሮ",
        "display_order": 1,
        "is_featured": True,
        "icon": "📱",
    },
    {
        ...
        "description_am": "ባህላዊ እና ዘመናዊ ልብስ",
        "display_order": 2,
        "is_featured": True,
        "icon": "👗",
    },
    {
        ...
        "name_am": "ምግብ እና ቅመማ",
        "slug": "food",
        "description": "Ethiopian food and spices",
        "description_am": "የኢትዮጵያ ምግቦች እና ቅመሞች",
        "display_order": 3,
        "is_featured": True,
        "icon": "🌶️",
    },
    {
        ...
        "name_am": "ውበት",
        "slug": "beauty",
        "description": "Skin care and cosmetics",
        "description_am": "የቆዳ ክብካቤ እና ሜካፕ",
        "display_order": 4,
        "is_featured": False,
        "icon": "💄",
    },
    {
        ...
        "description_am": "የቤት እቃዎች እና የኮሽና ዕቃዎች",
        "display_order": 5,
        "is_featured": True,
        "icon": "🏠",
    },
    ...
    },
    {
        ...
        "name_am": "እንጀራ እና ጤፍ",
        "slug": "injera-teff",
        "description": "Injera, teff, and related products",
        "description_am": "እንጀራ፣ ጤፍ እና ተዛማጅ ምርቶች",
        "display_order": 9,
        "is_featured": False,
        "icon": "🫓",
        "parent_slug": "food",
    },
    {
        ...
        "name_am": "ቡና",
        "slug": "coffee",
        "description": "Ethiopian coffee varieties",
        "description_am": "የኢትዮጵያ ቡና ዓይነቶች",
        "display_order": 10,
        "is_featured": True,
        "icon": "☕",
        "parent_slug": "food",
...
PRODUCTS = [
    # ── Electronics ──────────────────────────────────────────────────────────
    {
        ...
        "sku": "ELEC-SAM-A34",
        "is_featured": True,
        "tags": ["samsung", "smartphone", "5g"],
        "image_seed": 10,
    },
    {
        "name": "Tecno Spark 20 Pro",
        "name_am": "ቴክኖ ስፓርክ 20 ፕሮ",
        ...
        "sku": "ELEC-TECNO-S20",
        "is_featured": False,
        "tags": ["tecno", "smartphone", "affordable"],
        "image_seed": 20,
    },
    {
        "name": "Itel Vision 3 Plus",
        "name_am": "ኢቴል ቪዥን 3 ፕሉስ",
        ...
        "sku": "ELEC-ITEL-V3",
        "is_featured": False,
        "tags": ["itel", "budget", "smartphone"],
        "image_seed": 30,
    },
    {
        "name": "Sony 43-inch Smart TV",
        "name_am": "ሶኒ 43 ኢንች ስማርት ቲቪ",
    ...
    },
    {
        ...
        "sku": "ELEC-HP-15S-I5",
        "is_featured": True,
        "tags": ["laptop", "hp", "intel"],
        "image_seed": 50,
    },
    # ── Clothing / Habesha Kemis ─────────────────────────────────────────────
    {
        "name": "White Habesha Kemis (Women)",
        "name_am": "ነጭ ሀበሻ ቀሚስ (ሴቶች)",
        ...
        "is_featured": True,
        "is_on_sale": False,
        "tags": ["habesha", "kemis", "traditional", "women"],
        "image_seed": 60,
    },
    {
        "name": "Habesha Netela Shawl",
        "name_am": "ሀበሻ ነጠላ",
        ...
        "sku": "CLTH-NT-001",
        "is_featured": False,
        "tags": ["netela", "shawl", "traditional"],
        "image_seed": 70,
    },
    {
        "name": "Men's Habesha Suit (Suit & Gabi)",
        "name_am": "የወንዶች ሀበሻ ካባ (ጋቢ)",
        ...
        "sku": "CLTH-HG-M-001",
        "is_featured": True,
        "tags": ["habesha", "gabi", "men", "traditional"],
        "image_seed": 80,
    },
    {
        "name": "Nike Air Max 270 (Sneakers)",
        "name_am": "ናይኪ አየር ማክስ 270",
    ...
    {
        "name": "Adidas Trefoil T-Shirt (Men)",
        "name_am": "አዲዳስ ቲሸርት (ወንዶች)",
    ...
    # ── Food & Spices ────────────────────────────────────────────────────────
    {
        ...
        "category_slug": "injera-teff",
        "category_type": "food",
        "price": Decimal("320.00"),
        "stock_quantity": 200,
        "sku": "FOOD-TEFF-5KG",
        "is_featured": True,
        "tags": ["teff", "flour", "injera", "gluten-free"],
        "image_seed": 110,
    },
    {
        ...
        "sku": "FOOD-BERB-500G",
        "is_featured": True,
        "tags": ["berbere", "spice", "traditional", "hot"],
        "image_seed": 120,
    },
    {
        "name": "Mitmita Spice (250g)",
        "name_am": "ሚጥሚጣ (250ግ)",
        ...
        "sku": "FOOD-MITM-250G",
        "is_featured": False,
        "tags": ["mitmita", "spice", "chili", "hot"],
        "image_seed": 130,
    },
    {
        "name": "Yirgacheffe Coffee Beans (1kg)",
        "name_am": "ዮርጋጨፈ ቡና (1 ኪሎ)",
        ...
        "sku": "FOOD-YRG-1KG",
        "is_featured": True,
        "tags": ["coffee", "yirgacheffe", "beans", "light roast"],
        "image_seed": 140,
    },
    {
        "name": "Sidama Coffee Ground (500g)",
        "name_am": "ሲዳማ ቡና ዱቄት (500ግ)",
        ...
        "stock_quantity": 180,
        "sku": "FOOD-SID-GND-500G",
        "is_featured": False,
        "tags": ["coffee", "sidama", "ground"],
        "image_seed": 150,
    },
    {
        "name": "Niter Kibbeh (Spiced Butter 500g)",
        "name_am": "ንጥር ቅቤ (500ግ)",
        ...
        "sku": "FOOD-NITK-500G",
        "is_featured": False,
        "tags": ["niter kibbeh", "butter", "traditional", "cooking"],
        "image_seed": 160,
    },
    # ── Beauty & Care ────────────────────────────────────────────────────────
    {
        "name": "Argan Oil Shampoo (400ml)",
        "name_am": "አርጋን ኦይል ሻምፑ (400ml)",
        ...
        "sku": "BEAU-ARGSH-400",
        "is_featured": False,
        "tags": ["shampoo", "argan", "hair care"],
        "image_seed": 170,
    },
    {
        "name": "Ethiopian Rose Face Cream (50ml)",
        "name_am": "ኢትዮጵያ ጸዳ ቅባት (50ml)",
        ...
        "sku": "BEAU-ROFC-50",
        "is_featured": True,
        "tags": ["face cream", "rose water", "natural", "skin care"],
        "image_seed": 180,
    },
    {
        "name": "Black Seed (Tikur Azmud) Oil 250ml",
        "name_am": "ጥቁር አዝሙድ ዘይት (250ml)",
        ...
        "sku": "BEAU-BSO-250",
        "is_featured": False,
        "tags": ["black seed", "oil", "natural", "health"],
        "image_seed": 190,
    },
    # ── Home & Kitchen ───────────────────────────────────────────────────────
    {
        "name": "Ethiopian Coffee Ceremony Set",
        "name_am": "የቡና ሥርዓት ዕቃ ስብስብ",
        ...
        "stock_quantity": 40,
        "sku": "HOME-COFF-SET-01",
        "is_featured": True,
        "tags": ["coffee ceremony", "jebena", "traditional", "home"],
        "image_seed": 200,
    },
    {
        ...
        "sku": "HOME-MESOB-001",
        "is_featured": False,
        "tags": ["mesob", "basket", "traditional", "handmade"],
        "image_seed": 210,
    },
    {
        "name": "Non-stick Cooking Pot (3L)",
        "name_am": "ኖን-ስቲክ ድስት (3 ሊትር)",
        ...
        "sku": "HOME-NSP-3L",
        "is_featured": False,
        "tags": ["pot", "cooking", "kitchen", "non-stick"],
        "image_seed": 220,
    },
    {
        "name": "Solar LED Lantern (30W)",
        "name_am": "ሶላር LED ፋኖስ (30W)",
        ...
        "sku": "HOME-SOLLED-30",
        "is_featured": True,
        "tags": ["solar", "lantern", "light", "usb"],
        "image_seed": 230,
    },
    # ── Sports & Fitness ─────────────────────────────────────────────────────
    {
        "name": "Adjustable Dumbbell Set (20kg)",
        "name_am": "ዳምቤል ስብስብ (20 ኪሎ)",
    ...
    },
    {
        ...
        "description": "Eco-friendly 6mm thick non-slip yoga mat. 183x61cm. Carry strap included.",
        "description_am": "ኤኮ-ፍሬንድሊ 6mm ዮጋ ምንጣፍ። 183x61cm። ማሰሪያ ጨምሮ።",
    ...
    },
    {
        ...
        "sku": "SPRT-FTBL-S5",
        "is_featured": True,
        "tags": ["football", "soccer", "size 5", "sports"],
        "image_seed": 260,
    },
]
...
async def seed(session: AsyncSession) -> None:
    ...
    if existing_products:
        print(
            f"   ⚠️  Database already has {len(existing_products)} products — skipping (run with --force to re-seed)."
        )
    ...
    existing_user = (
        (await session.execute(select(User).where(User.telegram_id == 999_999_999)))
        .scalars()
        .first()
    )
    ...
    # ── 3. Vendor record ─────────────────────────────────────────────────────
    existing_vendor = (
        (await session.execute(select(Vendor).where(Vendor.user_id == vendor_user.id)))
        .scalars()
        .first()
    )
    ...
    for c_data in root_cats + child_cats:
        existing = (
            (await session.execute(select(Category).where(Category.slug == c_data["slug"])))
            .scalars()
            .first()
        )
    ...
    for p in PRODUCTS:
        existing = (
            (await session.execute(select(Product).where(Product.slug == p["slug"])))
            .scalars()
            .first()
        )
    ...
    for _slug, cat in cat_by_slug.items():
