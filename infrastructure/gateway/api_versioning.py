...
class VersionNegotiator:
    ...
    def get_handler(self, path: str, method: str, version: str | None = None) -> Callable | None:
        """
...
class VersionedRouter:
    ...
    def __init__(self, negotiator: VersionNegotiator | None = None):
    ...
    def get_versioned_handler(self, path: str, method: str, version: str) -> Callable | None:
...
def get_versioned_handler(path: str, method: str, version: str) -> Callable | None:
    """Get versioned handler."""
