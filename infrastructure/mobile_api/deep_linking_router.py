...
class DeepLinkRouter:
    ...
    def register_handler(
        ...
        self._handlers[link_type].append(
            DeepLinkHandler(
                link_type=link_type,
                handler=handler,
                priority=priority,
    ...
    async def handle_deep_link(self, url: str) -> Any | None:
        """
    ...
    def parse_deep_link(self, url: str) -> DeepLinkData | None:
        """
...
async def handle_deep_link(url: str) -> Any | None:
    """Handle a deep link URL."""
...
def parse_deep_link(url: str) -> DeepLinkData | None:
    """Parse a deep link URL."""
