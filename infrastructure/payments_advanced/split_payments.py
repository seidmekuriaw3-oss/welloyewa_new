...
class SplitPaymentStatus(StrEnum):
...
class SplitPaymentManager:
        ...
        for vendor_split in vendor_splits:
            splits.append(
                SplitPayment(
                    ...
                    vendor_name=vendor_split.get(
                        "vendor_name", f"Vendor {vendor_split['vendor_id']}"
                    ),
    ...
    async def _get_split_payment(self, main_transaction_id: str) -> dict | None:
