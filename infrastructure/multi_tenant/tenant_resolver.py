...
class TenantResolutionStrategy(StrEnum):
...
class TenantContext:
    ...
    def __init__(self, tenant_id: str, tenant_info: TenantInfo | None = None):
    ...
    @classmethod
    def get_current_tenant(cls) -> TenantInfo | None:
        """Get the current tenant from context."""
        return cls._current_tenant.get()

    @classmethod
    def set_current_tenant(cls, tenant: TenantInfo | None):
...
class TenantResolver:
    ...
    def resolve_from_request(self, request: Any) -> TenantInfo | None:
        """
    ...
    def _resolve_from_subdomain(self, request: Any) -> str | None:
