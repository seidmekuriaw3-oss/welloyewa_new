...
class AutoTicketRouter:
    ...
    def get_agent_for_ticket(
        ...
        """
        available_agents = [
            a for a in self._agents.values() if a.is_online and a.current_load < a.max_load
        ]
        ...
        if required_skills:
            available_agents = [
                a for a in available_agents if any(skill in a.skills for skill in required_skills)
            ]
    ...
    def get_routing_stats(self) -> dict[str, Any]:
        ...
        stats = {
            ...
            "available_agents": sum(
                1 for a in self._agents.values() if a.is_online and a.current_load < a.max_load
            ),
