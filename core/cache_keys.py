...
class CacheTTL:
    ...
    @classmethod
    def for_user(cls, user_id: int | None = None) -> int:
        """TTL for user data (shorter for active users)."""
        return cls.MEDIUM

    @classmethod
    def for_product(cls, product_id: int | None = None) -> int:
        """TTL for product data."""
        return cls.LONG

    @classmethod
    def for_product_list(cls, category: str | None = None) -> int:
        """TTL for product lists."""
        return cls.MEDIUM

    @classmethod
    def for_order(cls, order_id: int | None = None) -> int:
        """TTL for order data."""
        return cls.STANDARD

    @classmethod
    def for_session(cls, session_id: str | None = None) -> int:
        """TTL for session data."""
        return cls.SESSION

    @classmethod
    def for_analytics(cls, report_type: str | None = None) -> int:
...
class CacheKey:
    ...
    @staticmethod
    def user_orders(user_id: int, status: str | None = None) -> str:
    ...
    @staticmethod
    def vendor_products(vendor_id: int, status: str | None = None) -> str:
    ...
    @staticmethod
    def vendor_orders(vendor_id: int, status: str | None = None) -> str:
    ...
    @staticmethod
    def search_query(query: str, filters: dict | None = None, page: int = 1) -> str:
    ...
    @staticmethod
    def analytics_sales(
        period: str = "daily", start_date: str | None = None, end_date: str | None = None
    ) -> str:
    ...
    @staticmethod
    def api_response(endpoint: str, params: dict | None = None) -> str:
    ...
    @staticmethod
    def queue_notifications(user_id: int | None = None) -> str:
    ...
    @staticmethod
    def pending_payments(transaction_id: str | None = None) -> str:
    ...
    @classmethod
    def user_pattern(cls, user_id: int | None = None) -> str:
    ...
    @classmethod
    def product_pattern(cls, product_id: int | None = None) -> str:
    ...
    @classmethod
    def vendor_pattern(cls, vendor_id: int | None = None) -> str:
