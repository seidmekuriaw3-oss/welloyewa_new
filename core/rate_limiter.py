...
class TokenBucketLimiter:
    ...
    def __init__(self, limit: int, window_seconds: int, burst_limit: int | None = None):
...
class LeakyBucketLimiter:
    ...
    def __init__(self, limit: int, window_seconds: int, leak_rate: float | None = None):
        self.capacity = limit
        self.window_seconds = window_seconds
...
class RateLimiter:
    ...
    async def check(
        ...
        if self._use_redis and self._redis_client:
            return await self._check_redis(key, limit, window, strategy, burst_limit)
...
class UserRateLimiter:
    ...
    async def check_user(self, user_id: int) -> tuple[bool, int, int | None]:
