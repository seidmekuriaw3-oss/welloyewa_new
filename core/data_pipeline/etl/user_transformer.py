...
class UserTransformer:
    ...
    def transform_user(self, user_data: dict[str, Any]) -> dict[str, Any]:
        ...
        if self.anonymize_pii:
            ...
            transformed["phone_number"] = pii_masker.mask(
                user_data.get("phone_number", ""), keep_ends=2
            )
    ...
    def _anonymize_id(self, id_value: int | None) -> str | None:
    ...
    def _anonymize_username(self, username: str | None) -> str | None:
        """Anonymize username."""
        if not username:
            return None
    ...
    def _get_age_group(self, age: int | None) -> str | None:
    ...
    def _encode_city(self, city: str | None) -> int | None:
