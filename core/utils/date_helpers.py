...
DateType = datetime | date | str | int
...
class DateHelper:
    ...
    @classmethod
    def _format_ethiopian_date(cls, dt: datetime | date) -> str:
    ...
    @classmethod
    def start_of_day(cls, dt: DateType | None = None) -> datetime:
    ...
    @classmethod
    def end_of_day(cls, dt: DateType | None = None) -> datetime:
    ...
    @classmethod
    def start_of_week(cls, dt: DateType | None = None) -> datetime:
    ...
    @classmethod
    def start_of_month(cls, dt: DateType | None = None) -> datetime:
        """Get start of month."""
        if dt is None:
            dt = cls.today()
        date_obj = cls._to_date(dt)
    ...
    @classmethod
    def start_of_year(cls, dt: DateType | None = None) -> datetime:
        """Get start of year."""
        if dt is None:
            dt = cls.today()
        date_obj = cls._to_date(dt)
...
def format_date(dt: DateType | None = None, locale: str = "am") -> str:
