...
class TestProductEndpoints:
    ...
    async def test_get_products_with_filters(self, client: AsyncClient):
        ...
        response = await client.get(
            "/api/v1/products/?category=electronics&min_price=100&max_price=5000"
        )
    ...
    async def test_create_product_review(self, client: AsyncClient, sample_user_data, auth_token):
        ...
        if products:
            ...
            response = await client.post(
                f"/api/v1/products/{product_id}/reviews", json=review_data, headers=headers
            )
...
class TestVendorProductEndpoints:
    ...
    async def test_create_product(
        self, client: AsyncClient, sample_user_data, sample_product_data, auth_token
    ):
...
__all__ = [
    ...
    "TestProductReviewsEndpoints",
    "TestVendorProductEndpoints",
]
